...
1. **顶部显示**：截图最顶部/最显眼处的大字「胜利」或「失败」，这是本局我方的比赛结果，务必准确识别
2. **左侧队伍**：阵营（蓝方/红方）、比赛结果（胜利/失败）、5名选手（游戏ID、分路、评分、奖牌）、MVP（若在本侧则填，否则 null）
3. **右侧队伍**：同上
4. **比赛日期**：格式 YYYY/M/D（如 2026/2/6），没有则返回 null
